...
try:
    cursor.executemany(
        "INSERT INTO source_sourceb(id,Object,obsid,RA,Dec,instrument,date_time,proposal_id,target_id,observer,abstract) VALUES(?,?,?,?,?,?,?,?,?,?,?)", to_db_src_B)
    con.commit()
except Exception as error:
    print(error)
